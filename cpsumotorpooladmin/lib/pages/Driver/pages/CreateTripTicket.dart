...
class _CreateTripTicketState extends State<CreateTripTicket> {
  ...
  final _vehicleController = TextEditingController(text: 'CPSU SAN CARLOS - L300');
  ...
  String? _selectedOrigin = 'CPSU SAN CARLOS';
  ...
  DateTime _arrivalDate = DateTime(2027, 8, 25);
  TimeOfDay _arrivalTime = const TimeOfDay(hour: 18, minute: 0);
          ...
          children: [
            ...
            _buildResponsiveFields(
              ...
              _buildDateField(
                ...
                date: _arrivalDate,
                time: _arrivalTime,
                onDateChanged: (value) => setState(() => _arrivalDate = value),
                onTimeChanged: (value) => setState(() => _arrivalTime = value),
              ),
            ),
  ...
  Widget _buildPassengerTile(int index, String name) {
    return Container(
      ...
      child: Column(
        children: [
          _buildReviewSection('Trip Information', [
            _reviewRow('Vehicle', _vehicleController.text),
            ...
            _reviewRow('Arrival', '${_formatDate(_arrivalDate)} at ${_formatTime(_arrivalTime)}'),
          ]),
                    ...
                    .map((passenger) => Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(passenger, style: const TextStyle(color: _ink, fontSize: 13)),
                            ],
                          ),
                        ))
                    .toList(),
          ...
          Row(
            children: [
              ...
              const SizedBox(width: 12),
              Expanded(child: _buildPrimaryButton('Submit Trip Ticket', _submitTicket)),
            ],
          ),
        ],
      ),
  ...
  Future<void> _showAddPassengerDialog() async {
    ...
    controller.dispose();
    if (name != null && mounted) setState(() => _passengers.add(name));
  }
